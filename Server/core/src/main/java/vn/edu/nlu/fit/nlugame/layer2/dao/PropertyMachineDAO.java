...
public class PropertyMachineDAO extends BaseDAO{
    ...
    public static List<PropertyMachineBean> getAllPropertyMachinesByUser(int userId) {
        ...
        return jdbi.withHandle(handle ->
                handle.createQuery("SELECT id, speed, durable, power, number_star, energy, value, rate, no_growth_item_id, user_id " +
    ...
    public static void insertPropertyMachine(PropertyMachineBean propertyMachineBean) {
        ...
        jdbi.useHandle(handle -> {
            handle.createUpdate("INSERT INTO " + TABLE_NAME + " (speed, durable, power, number_star, energy, value, no_growth_item_id, user_id, rate) " +
                    "VALUES (:speed, :durable, :power, :numberStar, :energy, :value, :noGrowthItemId, :userId: rate)")
                    ...
                    .bind("energy", propertyMachineBean.getEnergy())
    ...
    public static void insertPropertyMachines(List<PropertyMachineBean> propertyMachineBeans) {
        ...
        jdbi.useHandle(handle -> {
            PreparedBatch batch = handle.prepareBatch("INSERT INTO " + TABLE_NAME + " (speed, durable, power, number_star, energy, value, no_growth_item_id, user_id, rate) " +
                    "VALUES (:speed, :durable, :power, :numberStar, :energy, :value, :noGrowthItemId, :userId, :rate)");
    ...
    public static boolean updatePropertyMachine(PropertyMachineBean propertyMachineBean){
        ...
        int count = jdbi.withHandle(handle -> handle.createUpdate("UPDATE " + TABLE_NAME + " SET speed = :speed, durable = :durable, power = :power, number_star = :numberStar, energy = :energy, value = :value, rate = :rate " +
